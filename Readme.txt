...
![Original](output/sample_original.jpg)

### 🔹 Detected Sensitive Areas (Heatmap)
![Heatmap](output/sample_heatmap.jpg)

### 🔹 Anonymized Image (Blurred)
![Blurred](output/sample_blurred.jpg)

---

## 🔧 Future Improvements
✅ Improve text detection accuracy using **Deep Learning OCR**
✅ Enhance **number plate detection** with a fine-tuned YOLO model
✅ Add **face detection & blurring**
